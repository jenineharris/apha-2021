...
starbucks_spss <-
  read_sav(
    "https://github.com/kijohnson/ADA-Fall-2021/blob/master/Class%201/Class%201%20demo/starbucks_datasets/starbucks_spss.sav?raw=true")
```
...
```{r, chunk13}
starbucks_spss.different<-read_sav("/Users/kijohnson/Desktop/APHA demo/starbucks_datasets/starbucks_spss.sav")
```
